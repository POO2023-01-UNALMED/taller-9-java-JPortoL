			...
			switch (operator) {
				...
				case "/":
					if (num2 != 0) {
						...
						displayText.setText("No dividas por 0, ¿Acaso quieres que la realidad se rompa?");;
					}
					break;
			}

			if (!displayText.getText().equals("No dividas por 0, ¿Acaso quieres que la realidad se rompa?")) {
